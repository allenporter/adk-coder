...
3. Initialize the skill (run python3 init_skill.py)
4. Edit the skill (implement resources and write SKILL.md)
5. Package the skill (run python3 package_skill.py)
...
```bash
python3 <path-to-skill-creator>/scripts/init_skill.py <skill-name> --path <output-directory>
```
...
```bash
python3 <path-to-skill-creator>/scripts/package_skill.py <path/to/skill-folder>
```

Optional output directory specification:

```bash
python3 <path-to-skill-creator>/scripts/package_skill.py <path/to/skill-folder> ./dist
```
